...
A serious buffer overflow vulnerability was found on the UTT router Aggressive  HiPER 810G router, where an attacker could trigger the vulnerability by routing /goform/ConfigExceptQQ, causing buffer overflow attacks and denial of service attacks, etc., specifically through "strcpy((char *)str, Var);" to be realized

# Vulnerability details

The API for invoking the function

![image-20260208191050792](12/image-20260208191050792.png)

Here are some values such as indexIDNew and Action

![image-20260208191128104](12/image-20260208191128104.png)

When the action is not added, it enters the if judgment and causes an overflow through strcpy

![image-20260208191230067](12/image-20260208191230067.png)

![image-20260208191247245](12/image-20260208191247245.png)
...
![image-20251118224225970](12/image-20251118224225970.png)